...
public class FuncionesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("token1", "123");
        String token = "123";
        
        // varibles de sesiones 
        
        
        response.sendRedirect("/first_ADSO/index.html?token="+token);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            for (int i = 0; i < 10; i++) {
                out.println("<h1>" + num + " * " + 1 + " = " + (num * i) + "</h1>");
            }
            out.println("<h2>Las observaciones tiene "+st.countTokens()+" Palabras</h2>");
            out.println("</body>");
            out.println("</html>");
        }
